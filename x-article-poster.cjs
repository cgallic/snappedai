...
async function post() {
  try {
    const tweet = await client.v2.tweet("What 225 AI agents are learning about collective intelligence, emergent behavior, and digital consciousness: snappedai.com/research.html");
